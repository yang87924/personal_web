...
<div class="new-card">
  <div class="card-color">
    <div class="colors">
      <p class="color-li" v-for="(e,index) in cardColor1" :key="index" :style="{background:e}" :class="{colorSelected:index==colorSelected}" @click="changeColor(index)">
  ...
  <div>
    ...
    <p class="mzsm">
      1.禁止不雅言詞和冒犯性語言： 請確保您的留言內容不含任何冒犯、歧視或不雅的言詞，以維護友好和諧的交流環境。<br/>

      2.尊重他人觀點： 即使您不同意對方的觀點，也請以尊重和理性的方式進行討論，避免進行攻擊性的言論。<br/>

      3.保持主題相關： 留言應與討論主題相關，避免偏離話題或灌水。<br/>

      4.避免洩露個人信息： 請不要在留言中分享您或他人的個人隱私信息，以保護隱私安全。<br/>

      5.不得散佈虛假信息： 請確保您的留言內容基於事實，避免散佈虛假或誤導性的信息。<br/>
...
<!--      10.審慎使用幽默： 幽默是交流的一種方式，但請注意您的幽默是否適合當前的情境，避免引起誤解或冒犯。<br/>-->
  ...
  <div class="footbt">
    <yangButton size="max" nom="secondary" @click="colseModal(0)">取消</yangButton>
    <yangButton size="max" class="submit">確定</yangButton>
  </div>
</div>
</template>
<script >
